      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-sm font-bold mb-1">How do I create a listing?</h3>
              <p className="text-sm text-gray-600">
                Navigate to "Create Listing" from your dashboard and fill in all required information about your property including location, pricing, and amenities.
              </p>
            </div>

            <div>
              <h3 className="text-sm font-bold mb-1">When do I receive payment for bookings?</h3>
              <p className="text-sm text-gray-600">
                Payments are released to your account after the student completes their inspection and approves the accommodation. This typically takes 3-5 business days.
              </p>
            </div>

            <div>
              <h3 className="text-sm font-bold mb-1">How do inspection requests work?</h3>
              <p className="text-sm text-gray-600">
                When a student books your property, they can request an inspection. You'll receive a notification and can approve or reject the request. Coordinate with the student for a suitable time.
              </p>
            </div>

            <div>
              <h3 className="text-sm font-bold mb-1">Can I edit or delete my listings?</h3>
              <p className="text-sm text-gray-600">
                Yes, you can edit listing details or mark properties as unavailable at any time from your listings page. Active bookings won't be affected by changes.
              </p>
            </div>
          </div>
        </div>
